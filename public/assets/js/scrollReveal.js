window.scrollReveal = (function (window) {
  ...
  ScrollReveal.prototype = {
    ...
    genCSS: function (el) {
      ...
      var dur = parsed.over || this.options.over;
      var delay = parsed.after || this.options.after;
      var easing = parsed.easing || this.options.easing;
      var opacity = parsed.opacity || this.options.opacity;
